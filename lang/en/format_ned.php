...
$string['loadcolourschema'] = 'Load colour schema';
...
$string['managecolourschemas'] = 'Manage colour schemas';
$string['add'] = 'Add';
$string['rowcount'] = '';
$string['action'] = '';
$string['name'] = 'Name';
...
$string['sectionhighlight'] = 'Section highlight';
$string['bar'] = 'Bar';
$string['border'] = 'Border';
$string['sectionnamesetting'] = 'Section name';
$string['sectionsummaryetting'] = 'Section summary';
