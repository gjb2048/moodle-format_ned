...
var i=a(this).find(":selected").val();switch(i){case"0":d.text(b);break;case"1":var j=f.val();j.trim()?d.text(j):d.html("&nbsp;");break;case"2":var k=g.val();k.trim()?d.text(k):d.html("&nbsp;");break;case"3":var l=h.val();l.trim()?d.text(l):d.html("&nbsp;")}e=i})},f.on("keyup",function(b){"1"==e&&// Left column.
