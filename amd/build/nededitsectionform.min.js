...
p.text(c.sectionnamenavblockvaluedata[0])};o.on("change",function(b){
// Change the navigation name block value.
var d=a(this).find(":selected").val();p.text(c.sectionnamenavblockvaluedata[d])}),this.on("change",function(b){q(a(this))})}}(a),{init:function(c){a(document).ready(function(a){a("select#id_sectionheaderformat").sectionHeaderFormat(c),window.JSON&&window.JSON.stringify&&b.debug("NED Format Edit Section Form AMD data: "+JSON.stringify(c))}),b.debug("NED Format Edit Section Form AMD init.")}}});