...
// Individual toggles.
a("ul.nededitingsection li.section .left .nededitingsectionpix").click(function(b){a(this).hasClass("closed")?a(this).removeClass("closed").addClass("open"):a(this).removeClass("open").addClass("closed"),a(this).parent(".left").parent(".section").find(".content .section").each(function(){
//$(this).html('<div>Me!</div>');
var b=a(this).attr("nedsectionno");void 0!=b?(a(this).getSection(c.courseid,b),Y.use("moodle-course-dragdrop",function(){M.course.init_section_dragdrop({courseid:"5",ajaxurl:"/course/rest.php",config:{resourceurl:"/course/rest.php",sectionurl:"/course/rest.php",pageparams:[]}})})):a(this).toggle()})}),
